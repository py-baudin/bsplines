...
extensions = [None, 'constant', 'nearest', 'half-symmetric', 'whole-symmetric', 'true-periodic']
...
for i in range(6):
    ...
    if ext is None:
        value = 0.5
    for axis in [0, 1]:
        im = bsplines.apply_extension(im, 5, axis=axis, extension=ext or 'constant', value=value)
    plt.sca(axes.flat[i])
