...
degree = 3
fig, axes = plt.subplots(nrows=2, ncols=2, num='compare-scipy-1d', sharex=True, sharey=True)
...
fig, axes = plt.subplots(nrows=2, ncols=2, num='compare-scipy-1d-derivatives', sharex=True, sharey=True)
for i, ext in enumerate([None, 'natural', 'clamped', 'periodic']):
    plt.sca(axes.flat[i])
