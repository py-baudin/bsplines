...
cf = costfun(f, jf)
res = optimize.minimize(cf, init, jac=cf.jac, bounds=bounds, options={'disp': True, 'maxiter': 500})
sol = cf.parse(res.x)
pred = f(sol)
...
res2 = optimize.minimize(cf2, init, jac=cf2.jac, bounds=bounds, options={'disp': True, 'maxiter': 500})
